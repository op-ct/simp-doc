...
SIMP does not directly support system backup and recovery―solutions vary
widely, and should be determined as part of an implementation's broader
contingency plan. SIMP provides some mechanisms that might be used to support
backup and recovery procedures.

Administrators seeking FOSS software to implement backup and recovery may be
interested in products such as `Bacula <https://www.bacula.org/>`__, `BackupPC
<http://backuppc.sourceforge.net/>`__, `duplicity
